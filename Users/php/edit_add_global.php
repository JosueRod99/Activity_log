	...
	<ul>
		...
		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<table width="25%">
				...
				<?php
  							$i=1;
  							$sql = "SELECT * FROM `global_act` order by GID asc";
  							$result = mysqli_query($conection,$sql);
								while($row=mysqli_fetch_assoc($result)){
									if($row['GID']==39){}
									else{
  						?>
  					<form action="edit_master_global.php?sx=<?php echo $user;?>" method="post">
				<tr>
					<td> 
						<input type="text" name="UID" value="<?php echo $row['GID']; ?>"  readonly="readonly" > 
					</td>
					<td class="tg-celdas">
  						<input type="text" name="name" value="<?php echo $row['NAME']; ?>" > <p>
					</td>
					<td class="tg-celdas">
  						<input type="text" name="tid" value="<?php echo $row['TID']; ?>"  > <p>
					</td>
  			...
  			<form action="edit_master_global.php?sx=<?php echo $user;?>" method="post">
					<td > 
						<input type="text" name="UID" value="ADD" readonly="readonly" style="color:red;"> 
					</td>
					<td class="tg-celdas2"><br>
					...
					<td class="tg-celdas2"><br>
						<div class="wrap-input100 validate-input " >
							<input class="input100" type="text" name="tid" autocomplete="off" >
							<span class="focus-input100" data-placeholder="Type of Activity:"></span>
						</div>  						
					</td>
					<td ><button><img src="../images/sumbit.jpg" width="20px" height="20px"></button></td>
				</tr>
			...
			<table>
				...
				<tr>
					...
					<td class="tg-celdas">
  						...
  						<?php if($row['TID'] == 1){echo "OPERACIÓN";}
  								else{echo $row['NAME'];} 
  						?>
  						<p>
					</td>
