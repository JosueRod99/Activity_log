	...
	<br>
			...
			<table width="25%">
				...
				<?php
  						...
  						?>
  					<form action="edit_master_customer.php?sx=<?php echo $user;?>" method="post">
				<tr>
					<td> 
						<input type="text" name="UID" value="<?php echo $row['BID']; ?>" readonly="readonly"> 
					</td>
					<td class="tg-celdas">
  						<input type="text" name="name" value="<?php echo $row['NAME']; ?>" id="name" > <p>
					</td>
